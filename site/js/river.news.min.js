  ...
  render: function render() {
    ...
    return (
      React.createElement("div", {className: "panel panel-default"}, 
        ...
        React.createElement("div", {className: "panel-footer"}, "Made with ", React.createElement("a", {href: "https://push.superfeedr.com"}, "Superfeedr"), ". ", React.createElement("a", {href: "https://github.com/superfeedr/river.news"}, "Source"), ".")
      )
    );
  }
});
...
var Settings = React.createClass({displayName: "Settings",
  ...
  render: function render() {
    ...
    var demoButton = (React.createElement("button", {type: "button", className: "btn btn-default pull-right btn-link", onClick: this.demo}, "Use demo credentials"));
  ...
  render: function render() {
    ...
    var addSubscription = (React.createElement("tr", null, 
      React.createElement("td", null, 
        React.createElement("input", {type: "text", className: "form-control input-sm", ref: "feed", placeholder: "Feed URL"})
      ), 
      React.createElement("td", null, 
        React.createElement("button", {type: "submit", className: "btn btn-default btn-sm pull-right"}, 
    ...
    if(that.state.loading) {
      ...
      React.createElement("td", null, 
        React.createElement("input", {type: "text", className: "form-control input-sm", ref: "feed", disabled: true, placeholder: "Feed URL"})
      ), 
      React.createElement("td", null, 
...
var Subscription = React.createClass({displayName: "Subscription",
  ...
  render: function render() {
    ...
    var button = (React.createElement("button", {className: "btn btn-sm pull-right btn-danger", onClick: that.removeSubscription}, 
      React.createElement("span", {className: "glyphicon glyphicon-remove", "aria-hidden": "true"}), " Remove"
    ));
    if(that.state.loading) {
      button = (React.createElement("button", {className: "btn btn-sm pull-right btn-danger", disabled: true}, 
