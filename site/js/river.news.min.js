...
var River = React.createClass({displayName: "River",
  ...
  render: function render() {
    ...
    var subscriptionsButton = (React.createElement("button", {type: "button", className: subscriptionsButtonClasses.join(' '), onClick: function() {
      ...
      React.createElement("span", {className: "glyphicon glyphicon-list", "aria-hidden": "true"})
    ));
  ...
  render: function render() {
    ...
    var addSubscription = (React.createElement("tr", null, 
      React.createElement("td", null, 
        React.createElement("input", {type: "text", className: "form-control", ref: "feed", placeholder: "Feed URL"})
      ), 
      React.createElement("td", null, 
    ...
    if(that.state.loading) {
      ...
      React.createElement("td", null, 
        React.createElement("input", {type: "text", className: "form-control", ref: "feed", disabled: true, placeholder: "Feed URL"})
      ), 
      React.createElement("td", null, 
